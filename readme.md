...
<br/>
Although we see a lot of inter-participant variability in the delta between unrelated and related conditions (represented by the grey lines), we see a clear pattern across participants, with a larger negative deflection in the unrelated condition than the related condition.
<p align="center">
...
6. Kappenman, E. S., Farrens, J. L., Zhang, W., Stewart, A. X., & Luck, S. J. (2021). ERP CORE: An open resource for human event-related potential research. NeuroImage, 225, 117465. [[DOI](10.1016/j.neuroimage.2020.117465)] | [[OSF](https://osf.io/thsqg/)]
